...
**AuditKit coverage:** 95 automated technical controls, reached through the SOC 2 / PCI / CMMC crosswalk  
**What's not covered:** the remaining 1,101 organizational and policy controls
...
|-----------|---------------|----------------------|
| NIST 800-53 | 1,196 | 95 (8%) |
| SOC2 | 43 criteria | 38 on AWS (88%) |
| PCI-DSS | 312 requirements | 69 (22%) |
