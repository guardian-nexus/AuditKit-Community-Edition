...
// CIS 2.5 - Ensure log metric filter and alerts exist for project ownership assignments/changes
func (c *GCPCISManualChecks) CheckProjectOwnershipChanges() []CheckResult {
	return []CheckResult{{
		Control:     "CIS-GCP-2.5",
		Name:        "[CIS-GCP-2.5] Log Metric Filter - Project Ownership Changes",
		Status:      "MANUAL",
		Severity:    "HIGH",
...
func (c *GCPCISManualChecks) CheckAuditConfigChanges() []CheckResult {
	return []CheckResult{{
		Control:     "CIS-GCP-2.6",
		Name:        "[CIS-GCP-2.6] Log Metric Filter - Audit Config Changes",
		Status:      "MANUAL",
		Severity:    "HIGH",
...
func (c *GCPCISManualChecks) CheckCustomRoleChanges() []CheckResult {
	return []CheckResult{{
		Control:     "CIS-GCP-2.7",
		Name:        "[CIS-GCP-2.7] Log Metric Filter - Custom Role Changes",
		Status:      "MANUAL",
		Severity:    "MEDIUM",
...
func (c *GCPCISManualChecks) CheckVPCNetworkChanges() []CheckResult {
	return []CheckResult{{
		...
		Name:        "[CIS-GCP-2.10] Log Metric Filter - VPC Network Changes",
		Status:      "MANUAL",
		Severity:    "HIGH",
...
func (c *GCPCISManualChecks) CheckVPCRouteChanges() []CheckResult {
	return []CheckResult{{
		Control:     "CIS-GCP-2.9",
		Name:        "[CIS-GCP-2.9] Log Metric Filter - VPC Route Changes",
		Status:      "MANUAL",
		Severity:    "MEDIUM",
...
func (c *GCPCISManualChecks) CheckVPCFirewallChanges() []CheckResult {
	return []CheckResult{{
		Control:     "CIS-GCP-2.8",
		Name:        "[CIS-GCP-2.8] Log Metric Filter - VPC Firewall Changes",
		Status:      "MANUAL",
		Severity:    "CRITICAL",
...
func (c *GCPCISManualChecks) CheckCloudStorageIAMChanges() []CheckResult {
	return []CheckResult{{
		...
		Name:        "[CIS-GCP-2.11] Log Metric Filter - Cloud Storage IAM Changes",
		Status:      "MANUAL",
		Severity:    "HIGH",
...
func (c *GCPCISManualChecks) CheckSQLInstanceConfigChanges() []CheckResult {
	return []CheckResult{{
		...
		Name:        "[CIS-GCP-2.12] Log Metric Filter - SQL Instance Config Changes",
		Status:      "MANUAL",
		Severity:    "HIGH",
...
func (c *GCPCISManualChecks) CheckProjectOwnerOrEditorAssignment() []CheckResult {
	return []CheckResult{{
		Control:     "CIS-GCP-2.5",
		Name:        "[CIS-GCP-2.5] Log Metric Filter - Project Owner/Editor Assignment",
		Status:      "MANUAL",
		Severity:    "CRITICAL",
